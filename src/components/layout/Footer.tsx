...
export function Footer() {
  return (
    <footer className="border-t border-secondary-100 bg-secondary-50">
      <div className="container-ease py-12 lg:py-16">
        <div className="grid gap-8 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="mt-4 text-sm text-secondary-600">
              AI-powered real estate transactions. See your total costs, risks, and timeline upfront.
            </p>
            <div className="mt-6 space-y-2">
              <a
                href="mailto:hello@ease.app"
          ...
          <div className="grid grid-cols-3 gap-8 lg:col-span-3">
            <div>
              <h4 className="font-semibold text-secondary-900">Product</h4>
            ...
            <div>
              <h4 className="font-semibold text-secondary-900">Company</h4>
              <ul className="mt-4 space-y-2">
            ...
            <div>
              <h4 className="font-semibold text-secondary-900">Legal</h4>
              <ul className="mt-4 space-y-2">
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-secondary-200 pt-8 sm:flex-row">
          ...
          <div className="flex items-center gap-4">
            <a href="#" className="text-secondary-400 hover:text-secondary-600">
